...
namespace ApiFacade 
{
    ...
    {
        private const string DefaultComment = $"/*{Environment.NewLine}* This code was automatically generated by api-facade{Environment.NewLine}* https://github.com/Zaphyk/api-facade {Environment.NewLine}*/";
        private readonly ClassData _data;

        public FacadeBuilder(ClassData Data)
        {
            this._data = Data;
        }
